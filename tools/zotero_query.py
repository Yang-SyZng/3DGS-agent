...
ZoteroClientTools = [
    StructuredTool.from_function(zoteroclient.SearchOnParentTitle),
    StructuredTool.from_function(zoteroclient.GetParentsChildrenMetadatas),
    StructuredTool.from_function(zoteroclient.GetChildrenAttachment)
]
